...
/// `~/Library/Application Support/AgentNotch/agent-notch-hook.sh`, which Claude
...
struct HookCommandTests {
    ...
    func plainPathIsNotQuoted() {
        let path = "/Users/vijay/.agent-notch/agent-notch-hook.sh"
    ...
    @Test("quoting round-trips", arguments: [
        ...
        "/Users/v/Application Support/AgentNotch/agent-notch-hook.sh",
        "/Users/Vijay Patel/.agent-notch/agent-notch-hook.sh",
        "/tmp/it's/agent-notch-hook.sh",
        "/tmp/a$b/agent-notch-hook.sh",
        "/tmp/a;rm -rf x/agent-notch-hook.sh",
    ])
    ...
    func defaultPathIsSpaceFree() {
        ...
        #expect(path == "/Users/vijay/.agent-notch/agent-notch-hook.sh")
    ...
    func recognisesExact() {
        let want = "/Users/v/.agent-notch/agent-notch-hook.sh"
    ...
    func recognisesLegacyPath() {
        ...
        let old = "'/Users/v/Library/Application Support/AgentNotch/agent-notch-hook.sh'"
        let new = "/Users/v/.agent-notch/agent-notch-hook.sh"
    ...
    func rejectsForeign() {
        ...
        #expect(!HookSpec.isOurCommand("/tmp/not-agent-notch-hook.shx", desired: new))
    }
}

@Suite("SettingsMerge: migrating a stale registration")
struct SettingsMergeMigrationTests {
    private let old = "'/Users/example/Library/Application Support/AgentNotch/agent-notch-hook.sh'"
