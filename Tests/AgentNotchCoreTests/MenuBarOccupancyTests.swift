...
enum MenuBarFixture {
    ...
    /// 14 status items on a 1512 pt display, captured while AgentNotch was
    /// running. `17691` is AgentNotch's own 17 pt anchor at the left end of the
    ...
    /// itself at layer 24 (captured: 0,0 1512x33), AgentNotch's panel at
