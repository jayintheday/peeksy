...
struct ProjectLabelTests {
    ...
    func displayIsLastTwo() {
        #expect(ProjectLabel.display("/Users/vijay/Desktop/TestRepo/peeksy") == "TestRepo/peeksy")
    ...
    func sessionConvenience() {
        let s = Session(
            id: "s",
            source: .claudeCode,
            cwd: "/Users/vijay/Desktop/TestRepo/peeksy",
            updatedAt: t0,
            createdAt: t0
        )

        #expect(s.projectDisplay == "TestRepo/peeksy")
        #expect(s.projectKey == "/Users/vijay/Desktop/TestRepo/peeksy")
    }
}
