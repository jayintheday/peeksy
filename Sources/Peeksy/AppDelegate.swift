...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let ioQueue = DispatchQueue(label: "com.peeksy.io")
    ...
    /// The AppKit half of `SystemAppActivator`, injected so `PeeksyCore`
    ...
    private func installSignalHandlers(server: UnixSocketServer) {
        for sig in [SIGINT, SIGTERM] {
            ...
            source.setEventHandler { @Sendable in
                ...
                FileHandle.standardError.write(Data("peeksy stopped\n".utf8))
                exit(0)
            }
            source.resume()
    ...
    private func describe(_ error: UnixSocketServer.StartError) -> String {
        ...
        case let .alreadyRunning(pid):
            ...
            return "another peeksy is already listening on \(socketURL.path)\(who) — leaving it alone"
    ...
    private func fail(_ message: String) {
        ...
        FileHandle.standardError.write(Data("peeksy: \(message)\n".utf8))
